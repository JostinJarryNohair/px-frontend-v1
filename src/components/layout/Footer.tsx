    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">StatsPro</h3>
            <p className="text-gray-400 text-sm">
              Your ultimate sports betting platform with real-time data, predictive analytics, and a seamless betting experience.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/live-betting" className="text-gray-400 hover:text-white text-sm transition-colors">
                  Live Betting
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/responsible-gambling" className="text-gray-400 hover:text-white text-sm transition-colors">
